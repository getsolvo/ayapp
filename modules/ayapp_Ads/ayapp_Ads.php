...
class ayapp_Ads extends Company
{
    public $new_schema = true;
    public $module_dir = 'ayapp_Ads';
    public $object_name = 'ayapp_Ads';
    public $table_name = 'ayapp_ads';
